...
#while True:
  ...
  #BME280_GetHumidity()
  #BME280_GetPressure()
 # print(BME280_uglyHumidity())
 # print(BME280_uglyTemperature())
 # print(BME280_uglyPressure())
 # print ("        ")
  #time.sleep(0.1)
